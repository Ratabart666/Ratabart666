...
Alg.dibujo_reglineal(x, y, 0, 0, '(No matricial)sin(θ) refl vs sin(θ) inc',
                     'sin(θ) inc', 'sin(θ) refl', ax, 'ley de snell',True,False)
plt.show()
...
Alg.dibujo_reg(x, y, 1, (1, 1), 0, 0, '(Matricial)sin(θ) refl vs sin(θ) inc',
               'sin(θ) inc', 'sin(θ) refl', 'ley de snell', a,True,False)
plt.show()
...
print('Incertidumbre b=+-', ajuste[1][1])
print(
    'El coeficiente de correlación ajustado(ver conclusiones) es:', ajuste[2])
# Ajuste por scipy
print(23*'-')
...
print(23*'-')
print('Fuentes:')
print('-Mi propia libreria, ahí puede ver la implementación:',
      'https://github.com/Ratabart666/Ratabart666/tree/main/proyecto%20de%20aplicaciones')
print(' ')
