...
def mostrar_menu()->None:
    ...
    while c==0:
         ...
         print('(1) Retorna las posiciones de los primeros elementos repetidos en una lista')
         print ('(2) Cuenta el numero de veces que está una sublista en otra lista(Cuenta como uno aquellas sublistas repetidas sin elementos entre ellas)')
